...
function ProviderEditPatient() {
        ...
        async function fetchPatientData() {
            if (location.state && location.state.patient) {
                ...
                setFormValues({
                    ...
                    CurrentMedications: patient.CurrentMedications || [{ Name: '', Dosage: '', StartDate: '', EndDate: '' }],
    ...
    const validate = () => {
        ...
        let errors = {};
        const newErrors = {};
        if (!formValues.PatientID) newErrors.PatientID = 'PatientID is required.';
    ...
    return <ProviderLayout headerTitle={"Edit Patient"} isDashboard={true}>
            ...
            <form>
                ...
                <div className="mt-3 d-flex justify-content-between">
                    ...
                    <button onClick={(e) => handleCreate(e)}
                            ...
                            style={{backgroundColor: ButtonColor ? ButtonColor : ""}}>Update
                        Patient
...
export default ProviderEditPatient;

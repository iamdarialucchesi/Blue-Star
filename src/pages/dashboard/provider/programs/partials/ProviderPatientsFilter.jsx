...
const ProviderPatientsFilter = ({isShowFilterModal, setIsShowFilterModal}) => {
                        ...
                        <div id="panelsStayOpen-collapsetwo"
                            ...
                            <div className="accordion-body px-0 pt-0 pb-3">
                                ...
                                <div className="form-check d-flex gap-2 align-items-center mb-2">
                                    <input
                                        className="form-check-input shadow-none cursor-pointer border-secondary patients-filter-modal-checkbox"
                                        type="checkbox" value="" id="ResolvedCheckBox"/>
                                    <label
                                        className="form-check-label cursor-pointer mb-n1 fw-light detail-text text-light"
                                        htmlFor="ResolvedCheckBox">
                                        No
                                    </label>
                                </div>
                            </div>
            ...
            <div className="pt-3">
                ...
                <div className="form-check form-check-inline">
                    <input
                        ...
                        type="radio" name="gander" value="female"
                        id="flexRadioMale"/>
                    <label className="form-check-label cursor-pointer mb-n1 fw-light detail-text text-light" htmlFor="flexRadioMale">
                        Male
                    </label>
                </div>
                <div className="form-check form-check-inline">
                    <input
                        ...
                        type="radio" name="gander" value="female"
                        id="flexRadioFemale"/>
                    <label className="form-check-label cursor-pointer mb-n1 fw-light detail-text text-light" htmlFor="flexRadioFemale">
                        Female
                    </label>
                </div>
            </div>
...
export default ProviderPatientsFilter;
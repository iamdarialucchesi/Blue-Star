...
import DustbinRedIcon from "../../../assets/icons/trash.svg";  // Import the styles


function EditPatient() {
    const location = useLocation();
    const navigate = useNavigate();
    const {programNames, organizationsData} = usePatientsDataStore();
        ...
        async function fetchPatientData() {
            if (location.state && location.state.patient) {
                ...
                if (patient.OrganizationID) {
                    await fetchOrganizationPractices(patient.OrganizationID);
                }
                ...
                setFormValues({
                    ...
                    Program: patient.Program.map(program => ({
                        value: program.value,
                        label: program.label
                    })) || [],
                    ...
                    PrimaryCarePhysician: {
                        Name: patient.PrimaryCarePhysician.Name || '',
                        PhoneNumber: patient.PrimaryCarePhysician.PhoneNumber || ''
                    },
                    HealthHistory: {
                        PreExistingConditions: patient.HealthHistory.PreExistingConditions || '',
                        FamilyMedicalHistory: patient.HealthHistory.FamilyMedicalHistory || ''
                    },
                    SurgeryHistory: patient.SurgeryHistory || [{Procedure: '', Date: ''}],
                    ...
                    Allergies: patient.Allergies || [{Name: '', Effect: ''}]
                });
            }
        }
    ...
    const handleChangeOrganization = async (e) => {
        ...
        try {
            setIsLoading(true);
            const order = 'desc';
            const organizationPractices = await OrganizationAndPracticesService.fetchOrganizationPractices(authToken, value, order);
            if (organizationPractices && organizationPractices.length > 0) {
                setOrganizationPractices(organizationPractices);
            } else {
                setOrganizationPractices([]);
            }
            setIsLoading(false);
        } catch (error) {
            setIsLoading(false);
    ...
    const fetchOrganizationPractices = async (organizationsID) => {
        try {
            setIsLoading(true);
            const order = 'desc';
            const organizationPractices = await OrganizationAndPracticesService.fetchOrganizationPractices(authToken, organizationsID, order);
            if (organizationPractices && organizationPractices.length > 0) {
                setOrganizationPractices(organizationPractices);
            } else {
                setOrganizationPractices([]);
    ...
    const handleCreate = async (e) => {
        ...
        if (validate()) {
            try {
                setIsLoading(true);
                const result = await PatientsService.addPatients(authToken, formValues, loginUser);
                setIsLoading(false);
    ...
    return <AdminLayout headerTitle={"Edit Patient"} isDashboard={true}>
            ...
            <form>
                                ...
                                <div className="row px-2">
                                    <div className="col-md-6 col-lg-3 px-1 pb-3">
                                        <label htmlFor='FirstName'
                                               className='section-heading-3d3d3d-14px fw-normal pb-1'>First Name</label>
                                        <input
                                            type='text'
                                            id='FirstName'
                                            placeholder='Austin'
                                    ...
                                    <div className="col-md-6 col-lg-3 px-1 pb-3">
                                        <label htmlFor='LastName'
                                               className='section-heading-3d3d3d-14px fw-normal pb-1'>Last Name</label>
                                ...
                                <div className="row px-2">
                                    ...
                                    <div className=" col-md-6 col-lg-3 px-1 pb-3">
                                        <label htmlFor='PracticeID'
                                               className="form-label pb-1 m-0 fw-normal section-heading-3d3d3d-14px">Organization
                                            Practice</label>
                                        <select
                                            name="PracticeID"
                                        ...
                                        >
                                            ...
                                            {organizationPractices?.map(option => (
                                                <option key={option.OrganizationPracticeID}
                                                        value={option.OrganizationPracticeID}>
                                                    {option.PracticeName}
                                                </option>
                                            ))}
                                        </select>
                                        {errors.PracticeID &&
                                            <small className="text-danger">{errors.PracticeID}</small>}
                                    </div>
                                ...
                                <div className="row px-2">
                                    <div className="col-md-6 col-lg-4 px-1 pb-3">
                                        ...
                                        {errors.Address_Street &&
                                            <small className='text-danger'>{errors.Address_Street}</small>}
                                    </div>
                                    ...
                                    <div className="col-md-6 col-lg-3 px-1 pb-3">
                                        ...
                                        />
                                        {errors.Address_City &&
                                            <small className='text-danger'>{errors.Address_City}</small>}
                                    </div>
                                    ...
                                    <div className="col-md-6 col-lg-3 px-1 pb-3">
                                        ...
                                        {errors.Address_State &&
                                            <small className='text-danger'>{errors.Address_State}</small>}
                                    </div>
                                    ...
                                    <div className="col-md-6 col-lg-2 px-1 pb-3">
                                        ...
                                        {errors.Address_ZipCode &&
                                            <small className='text-danger'>{errors.Address_ZipCode}</small>}
                                    </div>
                                ...
                                <div className="row  px-2">
                                    <div className="col-md-6 col-lg-5 px-1 pb-3">
                                        ...
                                        {errors.Insurance_Provider &&
                                            <small className='text-danger'>{errors.Insurance_Provider}</small>}
                                    </div>
                                    ...
                                    <div className="col-md-6 col-lg-3 px-1 pb-3">
                                        ...
                                        <input
                                            ...
                                            className="form-control form-control placeholder-add-patient scroll-hide bg-field py-2"
                                        />
                                        {errors.Insurance_PolicyNumber &&
                                            <small className='text-danger'>{errors.Insurance_PolicyNumber}</small>}
                                    </div>
                                    ...
                                    <div className="col-lg-4 px-1 pb-3">
                                        ...
                                        <input
                                            ...
                                            className="form-control form-control placeholder-add-patient scroll-hide bg-field py-2"
                                        />
                                        {errors.Insurance_GroupNumber &&
                                            <small className='text-danger'>{errors.Insurance_GroupNumber}</small>}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="accordion-body py-0">
                                <div className="row px-2">
                                    <div className="col-md-6 col-lg-7 px-1 pb-3">
                                        ...
                                        />
                                        {errors.PrimaryCarePhysician_Name &&
                                            <small className='text-danger'>{errors.PrimaryCarePhysician_Name}</small>}
                                    </div>
                                    ...
                                    <div className="col-md-6 col-lg-5 px-1 pb-3">
                                        ...
                                        <input
                                            ...
                                            className="form-control form-control placeholder-add-patient scroll-hide bg-field py-2"
                                        />
                                        {errors.PrimaryCarePhysician_PhoneNumber && <small
                                            className='text-danger'>{errors.PrimaryCarePhysician_PhoneNumber}</small>}
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="row px-2">
                                    <div className="col-12 px-1 pb-3">
                                        ...
                                        <input
                                            ...
                                            className="form-control form-control placeholder-add-patient bg-field py-2"
                                        />
                                        {errors.HealthHistory_PreExistingConditions && <small
                                            className='text-danger'>{errors.HealthHistory_PreExistingConditions}</small>}
                                    </div>
                                    ...
                                    <div className="col-12 px-1 pb-3">
                                        ...
                                        <input
                                            ...
                                            className="form-control form-control placeholder-add-patient bg-field py-2"
                                        />
                                        {errors.HealthHistory_FamilyMedicalHistory && <small
                                            className='text-danger'>{errors.HealthHistory_FamilyMedicalHistory}</small>}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-3 d-flex justify-content-between">
                    ...
                    <button onClick={(e) => handleCreate(e)}
                            className="btn btn-primary px-3 detail-text d-flex align-items-center gap-2 rounded-3">Update
                        Patient <img width={10} height={10} src={PlusBlackIcon}/></button>
                </div>
            </form>
        </div>
    </AdminLayout>

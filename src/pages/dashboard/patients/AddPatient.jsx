...
function AddPatient() {
    ...
    const validate = () => {
        ...
        //     if (!formattedPhoneNumber) {
        //         newErrors.EmergencyContact_PhoneNumber = 'Enter a valid 10-digit Phone Number in the format (XXX) XXX-XXXX.';
        //     } else {
    ...
    // const handleDosageChange = (index, value, unit) => {
    //     const updatedMedications = formValues.CurrentMedications.map((medication, i) => {
    //         if (i === index) {
    //             const updatedMedication = { ...medication };
    //
    //             // Combine the numeric value and the unit to set Dosage
    //             updatedMedication.Dosage = `${value}${unit}`;
    //
    ...
    return <AdminLayout headerTitle={"Add Patient"} isDashboard={true}>
            ...
            <form>
                        ...
                        <div id="personal-details" className="accordion-collapse collapse show"
                            ...
                            <div className="accordion-body py-0">
                                ...
                                <div className="row px-2">
                                    ...
                                    {/*        Date of Birth*/}
                                    {/*    </label>*/}
                                    {/*    <div className='position-relative patient-date-picker'>*/}
                                    {/*        <DatePicker*/}
                                    ...
                                    {/*            className="form-control placeholder-add-patient right-date bg-field py-2"*/}
                                    {/*        />*/}
                                    {/*    </div>*/}
                                    {/*    {errors.DateOfBirth &&*/}
                ...
                <div className="mt-3 d-flex justify-content-between">
                    ...
                    <button onClick={(e) => handleCreate(e)}
                            className="btn btn-primary px-3 detail-text d-flex align-items-center gap-2 rounded-3">Add
